...
const Section1 = () => {
  ...
  return (
    <Box sx={{width: "100%"}}> 
      ...
      {/* Content */}
      <Container sx={{ height: "80vh", mt: 8, [theme.breakpoints.up('md')]: {mt: -5, mb:5}}}>
        <Stack sx={{ height: "100%" }} justifyContent="center">
          ...
          <Stack
            ...
            spacing={4}
          >
          <LaunchButton fullWidth={isSmallScreen}  sx={{ height: 50, px: 3 }}/>

          <CustomButton fullWidth={isSmallScreen} >
            <AppleIcon sx={{fontSize: 30, ml: -1}}/>
          ...
          <CustomButton fullWidth={isSmallScreen} >
          <GoogleIcon sx={{fontSize: 28, ml: 1}}/>
