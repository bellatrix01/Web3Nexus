    ...
    <Container sx={{ mt:{xs: 15, md: 20, lg:25} }} >
      ...
      <Grid item xs={12} md={6}>
        <Stack spacing={2} sx={{maxWidth: 480}}>
          ...
          <Typography variant="body2" color="text.secondary" sx={{pb:2}}>{top.subtitle}</Typography>
      ...
      {/* left*/}
      <Grid item xs={12} md={6}>
        <img src={bottom.TABS[tabValue].image} 
        ...
        <Stack spacing={2} sx={{maxWidth: 480}}>
          ...
          >
            {bottom.TABS.map(({name}) => (
              <Tab label={name} key={name} sx={{minWidth: 60, '&.Mui-selected':{color: 'text.primary'}}}/>
            ))}
          </Tabs>
          ...
          <a href="http://localhost:3000/"><OutlinedButton arrow fit>Open</OutlinedButton></a>
        </Stack>
        </Grid>
      </Grid>  
