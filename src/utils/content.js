...
export const section1Content = {
  ...
  HorseImage,
  ShootingStarImage,
  title: "Building Next-Gen",
  subtitle: "WebApp Network",
};
...
export const section4Content = {
  top: {
    ...
    subtitle:
      "Web3Nexus instantly analyzes thousands of quotes and fees across multiple DEXes to provide users with the best rates.",
    image: NewsImg,
  },
  bottom: {
    title: "Web3Nexus DeFi MarketPlace",
    TABS: [
      {
        name: "Buy",
        image: Phone1Img,
      ...
      },
      {
        ...
        image: Phone2Img,
        subtitle:
          "Stake Web3Nexus to participate in network governance and be eligible for gas costs refunds.",
      },
    ],
  },
};
...
export const section5Content = {
  BannerBgImage,
  BannerBgImageMobile,
  title: "Web3Nexus Uniswap",
  subtitle:
    "The Uniswap upgrade makes swaps on Web3Nexus yet more efficient and secure, combining liquidity from the entire crypto market in one place.",
};

export const section6Content = {
  title: "Web3nexus products",
  ITEMS: [
   
    { 
     
      title: "Funds Transfer App", 
      subtitle:
...
export const footerContent = {
  ...
  subscribe: {
    title: "Subscribe to Web3Nexus newsletter",
  ...
  copyright: {
    left: "© 2024 Web3Nexus, All Rights Reserved.",
    center: "ENS: Web3Nexus.eth",
    right: "Amey-Yashi 2024",
  },
};
